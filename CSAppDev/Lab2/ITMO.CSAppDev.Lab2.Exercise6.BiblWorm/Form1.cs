...
namespace ITMO.CSAppDev.Lab2.Exercise6.BiblWorm
{
    ...
    {   // Library list
        ...
        public string TitleMagazine // Magazine
        {
            get { return textBox4.Text; }
            set { textBox4.Text= value; }
        }
        public string Publisher // Books
        {
            get { return textBox3.Text; }
            set { textBox3.Text = value; }
        }
        public int Page // Books
        {
            get { return (int)numericUpDown1.Value; }
            set { numericUpDown1.Value = value; }
        }
        public int Year // Books
        {
            get { return (int)numericUpDown2.Value; }
            set { numericUpDown2.Value = value; }
        }
        public int InvNumber // Books
        {
            get { return (int)numericUpDown3.Value; }
            set { numericUpDown3.Value = value; }
        }
        public int PeriodUse // Books
        {
            get { return (int)numericUpDown4.Value; }
            set { numericUpDown4.Value = value; }
        }
        public bool Availability // Books
        {
            get { return (checkBox1.Checked); }
            set { checkBox1.Checked = value; }
        }
        public bool ReturnTime // Books
        {
            get { return (checkBox2.Checked); }
            set { checkBox2.Checked = value; }
        }
        public bool SortInvNumber // Books
        {
